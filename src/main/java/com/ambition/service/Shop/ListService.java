...
public class ListService {
    ...
    public List<Shop> queryShopList(String telephone, String delFlag) {

        ShopDao shopDao = new ShopDao();

        List<Shop> shopList = shopDao.queryShopList(null, null, null, telephone, null, null, Integer.valueOf(delFlag));
        return shopList;
