...
<html lang="en">
	...
	<head>
		...
		<link rel="shortcut icon" href="<%=path%>/after/favicon.ico" type="image/x-icon" />
		<link rel="stylesheet" href="<%=path%>/after/static/css/font.css">
		<link rel="stylesheet" href="<%=path%>/after/static/css/weadmin.css">
		<script type="text/javascript" src="<%=path%>/after/lib/layui/layui.js" charset="utf-8"></script>
	...
	<body>
		...
		<div class="container">
			<div class="logo">
				<a href="<%=path%>/after/index.jsp">WeAdmin v1.0</a>
			</div>
			<div class="left_open">
			...
			<ul class="layui-nav right" lay-filter="">
				<li class="layui-nav-item">
					...
					<dl class="layui-nav-child">
						...
						<dd>
							<a onclick="WeAdminShow('切换帐号','<%=path%>/after/login.jsp')">切换帐号</a>
						</dd>
						<dd>
							<a class="loginout" href="<%=path%>/after/login.jsp">退出</a>
						</dd>
					</dl>
				</li>
				<li class="layui-nav-item to-index">
					<a href="<%=path%>/after/login.jsp">前台首页</a>
				</li>
			</ul>
			...
			<div id="side-nav">
				<ul id="nav">
					<li>
						...
						<ul class="sub-menu">
							...
							<li>
								...
								<ul class="sub-menu">
									<li>
										<a _href="<%=path%>/after/pages/member/addInput.jsp">
											<i class="iconfont">&#xe6a7;</i>
											<cite>输入框操作</cite>
										</a>
									</li>
									<li>
										<a _href="<%=path%>/after/pages/404.jsp">
											<i class="iconfont">&#xe6a7;</i>
											<cite>三级菜单演示</cite>
										</a>
									</li>
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a _href="<%=path%>/after/pages/article/list.jsp">
									<i class="iconfont">&#xe6a7;</i>
									<cite>文章列表</cite>
								</a>
							</li>
...
//			});
			...
			layui.use(['jquery','admin'], function(){
				...
				$(function(){
					...
					if(login){
						if(login=0){
							window.location.href='<%=path%>/after/login.jsp';
							return false;
						}else{
							return false;
						}
