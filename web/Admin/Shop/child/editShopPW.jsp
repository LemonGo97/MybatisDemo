...
<form class="layui-form" action="">
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend>店铺名&nbsp;&nbsp;&nbsp;<font size="3" color="#cc4d1a">必填</font></legend>
    </fieldset>
    ...
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend>手机号&nbsp;&nbsp;&nbsp;<font size="3" color="#cc4d1a">这是你登陆系统的依据，不可更改</font></legend>
    </fieldset>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input id="telephone" type="tel" name="telephone"
                       autocomplete="off" class="layui-input" placeholder="请输入你的手机号" disabled="disabled">
            </div>
        </div>
    </div>
    <div align="center">
